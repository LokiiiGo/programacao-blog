...
if (container) {
  posts.forEach((post) => {
    ...
    link.className =
      "group block rounded-lg border border-gray-200 bg-white p-4 transition duration-300 ease-in-out hover:-translate-y-1 hover:border-sky-400 hover:shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-400";
